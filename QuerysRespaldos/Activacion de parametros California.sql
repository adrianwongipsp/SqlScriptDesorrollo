...
------ACTIVACION---------California  SantaBarbara PISCINA 7 633 CICLO 9 IDEJE: 1629 NUEVO id  5379 '2024-03-23'()---------------------------------------------------------------------------
SELECT * FROM proControlParametro c inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro
WHERE idPiscina= 633 and idPiscinaEjecucion= 1629 and fechaControl >='2024-03-23'  and activo=0

SELECT * FROM PiscinaUbicacion    WHERE nombreCamaronera='Santa Barbara' and nombrePiscina = '7' AND idPiscina = 633
SELECT * FROM proPiscinaEjecucion WHERE idPiscina = 633 

--128 registros --CONTROL DE PARAMETROS (ACTIVAR)

--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5379  
...
SELECT * FROM  proMuestreoPeso c inner join proMuestreoPesoDetalle d on c.idMuestreo = d.idMuestreo WHERE idPiscina = 633 and idPiscinaEjecucion= 5379 
...
SELECT * FROM  proPiscinaControlPeso WHERE idPiscinaEjecucion= 1629 
 ...
 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion =  5379
 --from  proPiscinaControlPeso d WHERE idPiscinaEjecucion = 1629 AND d.activo = 1 and fechaMuestreo >='2024-03-23' 
...
SELECT * FROM proControlParametro c inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro
WHERE idPiscina= 694 and idPiscinaEjecucion = 4899 and fechaControl >= '2024-03-23'  and activo = 0
...
--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5381  
...
SELECT * FROM  proMuestreoPeso c inner join proMuestreoPesoDetalle d on c.idMuestreo = d.idMuestreo WHERE idPiscina = 694 and idPiscinaEjecucion = 5381 
...
SELECT * FROM  proPiscinaControlPeso WHERE idPiscinaEjecucion = 4899 
 ...
 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion =  5381
 --from  proPiscinaControlPeso d WHERE idPiscinaEjecucion = 4899 AND d.activo = 0 and fechaMuestreo >='2024-04-02' 
...
-- 44 registros --CONTROL DE PARAMETROS (ACTIVAR)

--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5380  
...
and fechaMuestreo >='2024-04-01' and activo = 0
...
--******************
-----***NO AFECTA PAR VALIDACION PERO PARA CONTROL DE PISCINA CORRECTO***-----
SELECT * FROM  proPiscinaControlPeso WHERE idPiscinaEjecucion = 4990 
 and fechaMuestreo >='2024-04-01'  and activo = 0

 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion =  5380
 --from  proPiscinaControlPeso d WHERE idPiscinaEjecucion = 4990 and fechaMuestreo >='2024-04-01'  and activo = 0
...
and fechaControl between '2024-01-04' and '2024-03-23' and activo = 0

SELECT * FROM proControlParametro c 
inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 676 and idPiscinaEjecucion = 1000 
and fechaControl >= '2024-03-24' and activo = 0

-- 678 registros --CONTROL DE PARAMETROS (ACTIVAR)

--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5386  
--FROM proControlParametro c 
--inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 676 and idPiscinaEjecucion = 1000 
--and fechaControl between '2024-01-04' and '2024-03-23' and activo = 0

	--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5392  
	--FROM proControlParametro c 
	--inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 676 and idPiscinaEjecucion = 1000 
	--and fechaControl >= '2024-03-24' and activo = 0
...
and fechaMuestreo between '2024-01-04' and '2024-03-23' and activo = 0

SELECT * FROM  proMuestreoPeso c inner join proMuestreoPesoDetalle d on c.idMuestreo = d.idMuestreo WHERE idPiscina = 676 and idPiscinaEjecucion = 1000 
and fechaMuestreo  >= '2024-03-24' and activo = 0
...
--******************
-----***NO AFECTA PAR VALIDACION PERO PARA CONTROL DE PISCINA CORRECTO***-----
SELECT * FROM  proPiscinaControlPeso WHERE idPiscinaEjecucion= 1000 
 and fechaMuestreo between '2024-01-04' and '2024-03-23' and activo=1

 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion =  5386
 --FROM  proPiscinaControlPeso d WHERE idPiscinaEjecucion= 1000 
 --and fechaMuestreo between '2024-01-04' and '2024-03-23' and activo=1

SELECT * FROM  proPiscinaControlPeso WHERE idPiscinaEjecucion= 1000 
 and fechaMuestreo >= '2024-03-24' and activo=1
...
SELECT * FROM proControlParametro c 
inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 579 and idPiscinaEjecucion IN (2906)
and fechaControl between '2024-01-15' and '2024-02-28' and activo = 0

--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5387  
--FROM proControlParametro c inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 579 and idPiscinaEjecucion IN (2906)
--and fechaControl between '2024-01-15' and '2024-02-28' and activo = 0

SELECT * FROM proControlParametro c 
inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 579 and idPiscinaEjecucion IN (3946)
and fechaControl between '2024-02-29' and '2024-03-27' and activo = 0 

--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5395  
--FROM  proControlParametro c inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 579 and idPiscinaEjecucion IN (3946)
--and fechaControl between '2024-02-29' and '2024-03-27' and activo = 0 


SELECT * FROM proControlParametro c 
inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 579 and idPiscinaEjecucion IN (5398)
and fechaControl >='2024-03-27' and activo = 1

--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5398   
--FROM proControlParametro c inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 579 and idPiscinaEjecucion IN (4867)
...
-- 341 registros --CONTROL DE PARAMETROS (ACTIVAR)
	...
	and fechaMuestreo between '2024-01-15' and '2024-02-28' and activo = 0
 ...
 --and fechaMuestreo between '2024-01-15' and '2024-02-28' and activo = 0
	...
	SELECT * FROM  proMuestreoPeso c inner join proMuestreoPesoDetalle d on c.idMuestreo = d.idMuestreo WHERE idPiscina = 579 and idPiscinaEjecucion IN (2906,3946,4867)
	and fechaMuestreo between '2024-02-29' and '2024-03-27' and activo = 0
 ...
 --and fechaMuestreo between '2024-02-29' and '2024-03-27' and activo = 0
	...
	SELECT * FROM  proMuestreoPeso c inner join proMuestreoPesoDetalle d on c.idMuestreo = d.idMuestreo WHERE idPiscina = 579 and idPiscinaEjecucion IN (2906,3946,4867)
	and fechaMuestreo >='2024-03-27' and activo = 0
...
--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5393  
...
SELECT * FROM  proPiscinaControlPeso WHERE idPiscinaEjecucion = 4853 
 and fechaMuestreo  >='2024-03-28' and activo = 0
...
--UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5284  
...
-- 12 registros --CONTROL DE PARAMETROS (ACTIVAR)
	 ...
	 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5388  
...
and fechaMuestreo >='2024-04-02'  and activo = 1
 ...
 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion =  5364
 --from  proPiscinaControlPeso d WHERE idPiscinaEjecucion = 5283 AND fechaMuestreo >= '2024-04-02'  and activo = 1
--------------------------------------------------------------------------------------------------------------------------------------------------
GO

 ---------------CALIFORNIA SANTA ROSA SANTA ROSA PC34 PISCINA 599 CICLO 5 IDEJE: 4188 NUEVO id '2024-04-06'()-------------------------------------------------------------------------------------------

SELECT * FROM EjecucionesPiscinaView WHERE idPiscinaEjecucion IN (4188)

SELECT * FROM EjecucionesPiscinaView WHERE idPiscina IN (599)

SELECT * FROM proControlParametro c 
inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 599 --and idPiscinaEjecucion IN (4188)
...
--   and fechaControl >='2024-04-06' and activo = 0
	...
	SELECT * FROM  proMuestreoPeso c inner join proMuestreoPesoDetalle d on c.idMuestreo = d.idMuestreo  WHERE idPiscina = 599 --and idPiscinaEjecucion IN (4188)
...
--******************
-----***NO AFECTA PAR VALIDACION PERO PARA CONTROL DE PISCINA CORRECTO***-----
SELECT * FROM  proPiscinaControlPeso WHERE  idPiscinaEjecucion = 5364 
and fechaMuestreo >='2024-04-06'  and activo = 1
...
-- 84 registros --CONTROL DE PARAMETROS (ACTIVAR)
	 ...
	 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5399  
	 --FROM  proControlParametro c inner join proControlParametroDetalle d on c.idControlParametro = d.idControlParametro WHERE idPiscina = 673 and idPiscinaEjecucion IN (1636)
  -- and fechaControl >='2024-04-02' and activo = 0
...
--******************
-----***NO AFECTA PAR VALIDACION PERO PARA CONTROL DE PISCINA CORRECTO***-----
SELECT * FROM  proPiscinaControlPeso WHERE  idPiscinaEjecucion = 1636 
and fechaMuestreo >='2024-04-02'  and activo = 1
 
 --UPDATE d set d.activo = 1, d.idPiscinaEjecucion =  5399
 --from  proPiscinaControlPeso d WHERE idPiscinaEjecucion = 1636 and fechaMuestreo >='2024-04-02'  and activo = 1
...
--	 UPDATE d set d.activo = 1, d.idPiscinaEjecucion = 5400  
