...
CREATE TABLE [proContactoDocumento] (
  ...
  [IdEstado] int NULL,
  PRIMARY KEY CLUSTERED ([IdArchivo], [IdContacto], [IdDocumento], [IdTipoDocumento])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
)
GO
...
GO
ALTER TABLE [proContactoDocumento] ADD CONSTRAINT [fk_proContactoDocumento_IdContacto] FOREIGN KEY ([IdContacto]) REFERENCES [proContacto] ([IdContacto])
GO
ALTER TABLE [proContactoDocumento] ADD CONSTRAINT [fk_proContactoDocumento_IdArchivo] FOREIGN KEY ([IdArchivo]) REFERENCES [genArchivo] ([IdArchivo])
GO
ALTER TABLE [proContactoDocumento] ADD CONSTRAINT [fk_proContactoDocumento_IdDcoumento_IdTipoDocumento] FOREIGN KEY ([IdDocumento], [IdTipoDocumento]) REFERENCES [genDocumento] ([IdDocumento], [IdTipoDocumento])
GO
