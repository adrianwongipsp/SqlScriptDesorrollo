...
--select * from proPedidoBin where idPedidoBin = 6373 and zona = '10'
--update  proPedidoBin set zona = '10' where idPedidoBin = 6373 and zona = '18'
--update  proPedidoBin set zona = '18' where idPedidoBin = 6373 and zona = '10'

--select * from parZona where codigo in ('18','25','24')
--select * from parZona where codigo in ('10')
--select   ca.idPedidoBin, count(distinct mp.codigoZona) cantidad_zonas
...
--	group by  ca.idPedidoBin having count(distinct mp.codigoZona) > 1
...
BEGIN TRAN
		...
		END
													 ...
													 select COUNT(*) AS PEDIDOS_ACTUALIZADOS  from proPedidoBin WITH(NOLOCK) where estacionModificacion = @Modifica AND estacionCreacion <> @Modifica AND ESTADO <> 'ANU'
